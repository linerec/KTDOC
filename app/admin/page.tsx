...
export default async function AdminDashboardPage() {
  ...
  const steps: GuideStep[] = [
    ...
    },
    {
      ...
      label: '공연 기록',
      title: '공연을 기록합니다',
      desc: "지난 공연·행사를 사진·유튜브 영상과 함께 공연으로 등록합니다. '공개'한 공연은 갤러리 페이지에 연도별로 정리되어 쌓입니다. 무용단을 대표하는 무대 기록입니다.",
    ...
    },
    {
      ...
      label: '대표 공연',
      title: '대표 공연을 지정합니다',
      desc: "가장 내세우고 싶은 공연 하나를 '대표'로 지정하면, 공연 페이지 상단에 크게 소개됩니다. 마지막 단계입니다.",
